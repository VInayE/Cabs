      ...
      <v-card>
        <v-form v-model="valid" ref="form">
          <v-toolbar dark class="white cd_fixed_header" >
            <v-btn icon @click.native="closeGSTForm" dark>
          ...
          <v-layout row wrap class="gst_form_background">
            <v-flex xs12 class="gst_form_div">
              <v-layout row wrap class="gst_head" >
                  Please fill the details as per your GST registration
              </v-layout>
              <v-container fluid>
                  <v-layout row wrap class="gst input-group__input">
                      ...
                      <v-flex xs4 class="inputHeight select">
             ...
             <v-btn block  @click="saveGSTForm" class="gst-btn" >
