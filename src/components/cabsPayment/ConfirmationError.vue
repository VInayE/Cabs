              ...
              <div class="modal-body">
                  ...
                  <div class="modal-footer">
                    <slot name="footer mt16">
                        <a class="txt_blue font-bold darken-2 pb15" flat="flat" @click="closeDialog">OK</a>
                    </slot>
                  </div>
              </div>
          </div>
...
<script>
    ...
    export default {
        props: ['errorMessage','showConfirmationDialog'],
computed:{
    ...mapGetters({
       ...
       openConfirmationDialog: function () {
         if( this.getcabsSRPData.cabType == selfDrive){
            ...
            this.errorMessage=this.errorMessage
             adobeAnalyticsPageView("yt:self drive:checkout:booking failure","self drive","app android/app ios/pwa","business","self drive checkout","booking failure","","")
          }
       },
     },
    methods:{
